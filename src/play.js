    ...
    return (
      <div className="section">
        <h1 className="title has-text-centered">ABOUT ME</h1>
          <img  src={marathon} alt="Marathon" align="right" height="300" width="300" hspace="20" vspace="10"/>
          ...
          <img src={climbing} alt="Climbing" align="left" height="300" width="200" hspace="20" vspace="10"/>
          ...
          <img src={psalm} alt="Singing" align="right" height="300" width="200" hspace="20" vspace="10"/>
          </p>
          ...
          <img src={cross} alt="Faith" align="left" height="300" width="200" hspace="20" vspace="10"/>
          ...
          <img src={backpacking} alt="Backpacking" align="center"/>
